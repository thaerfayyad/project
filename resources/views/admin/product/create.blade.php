            ...
            <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form autocomplete="off" method="post" action="{{route('storeProducts')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label class="form-form-control-label" for="products Name">Product Name</label>
                                    <input class="form-control" id="Name" type="text" name="name" placeholder="product Name" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" required id="v-message" name="description" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="At least a 20 character comment.." data-parsley-validation-threshold="10" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="price">Price</label>
                                <input class="form-control" id="Name" type="text" name="price" placeholder="Price in $" autocomplete="off">
