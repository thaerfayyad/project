            ...
            <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form autocomplete="off" method="post" action="{{route('updateUser',['id'=>$user->id])}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label class="form-form-control-label" for="formBasicFirstName">First Name</label>
                                    <input class="form-control" id="formBasicFirstName" type="text" name="first_name" value="{{$user->first_name}}" autocomplete="off">
                                </div>
                                <div class="form-group col-sm-6">
                                    <label class="form-form-control-label" for="formBasicLastName">Last Name</label>
                                    <input class="form-control" id="formBasicLastName" type="text" name="last_name" placeholder="Last Name" value="{{$user->last_name}}" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-form-control-label" for="formBasicEmail">Email Address</label>
                                <input class="form-control" id="formBasicEmail" type="email" name="email" placeholder="Email Address" value="{{$user->email}}" disabled="" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label class="form-form-control-label" for="formBasicPassword">Password</label>
                                <input class="form-control" id="formBasicPassword" type="password" name="password" placeholder="Password" value="{{$user->password}}" autocomplete="off">
                            </div>
                                ...
                                <div>
                                    <div class="radio radio-inline">
                                        <input id="formBasicMale" type="radio" value="1" name="role"
                                            @if($user->role == 1) checked=""
                                            @endif
                                        >
                                        <label for="formBasicMale">Admin</label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <input id="formBasicFemale" type="radio" value="0" name="role"
                                            @if($user->role == 0) checked=""
                                            @endif
                                        >
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="radio radio-inline">
                                        <input id="formBasicMale" type="radio" value="male" name="gender"
                                            @if($user->gender == 'male') checked=""
                                            @endif
                                        >
